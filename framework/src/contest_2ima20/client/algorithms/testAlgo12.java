...
public class testAlgo12 extends SchematicTreesAlgorithm {
    ...
    public Output doAlgorithm(Input input) {
        ...
        double decay = 1.25;
        double alpha = 0.3; // weight for center-of-mass attraction
        ...
        for (int setIndex = 0; setIndex < input.sets.size(); setIndex++) {
            ...
            for (Node node : nodeSet) {
                ...
                for (int[] pos : candidates) {
                    ...
                    double score = weightedDist + centerAttract + randomness;
    ...
    private double manhattan(double x1, double y1, double x2, double y2) {
        return Math.abs(x1 - x2) + Math.abs(y1 - y2);
    }
