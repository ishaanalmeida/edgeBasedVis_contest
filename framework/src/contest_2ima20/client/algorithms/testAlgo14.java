...
public class testAlgo14 extends SchematicTreesAlgorithm {
    ...
    public Output doAlgorithm(Input input) {
        ...
        double decay = 1.25;
        double alpha = 0.3;  // center-of-mass attraction weight
        double beta = 0.2;   // mst-anchor proximity weight
        ...
        for (int setIndex = 0; setIndex < input.sets.size(); setIndex++) {
            ...
            for (Node node : nodeSet) {
                ...
                for (int[] pos : candidates) {
                    ...
                    double score = weightedDist + centerAttract + mstAnchor + randomness;
