...
public class testAlgo11 extends SchematicTreesAlgorithm {
                ...
                for (int[] pos : candidates) {
                    ...
                    if (size == 0) {
                        ...
                        for (int i = 0; i < size; i++) {
                            ...
                            double weight = Math.pow(size - i, baseDecay);
                            weightedDist += weight * manhattan(pos[0], pos[1], placed.x(), placed.y());
                        }
                        weightedDist /= size;
                    }

                    double randomness = (nodeIdx >= 2) ? random.nextDouble() * randomWeight : 0;
                    double score = weightedDist + randomness;
