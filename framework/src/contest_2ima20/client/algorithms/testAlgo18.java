...
public class testAlgo18 extends SchematicTreesAlgorithm {
        ...
        for (int setIndex = 0; setIndex < input.sets.size(); setIndex++) {
            ...
            while (iterator.hasNext()) {
                ...
                for (int[] pos : candidates) {
                    ...
                    double randomness = random.nextDouble() * randomWeight / (placedPositions.size() + 1);
